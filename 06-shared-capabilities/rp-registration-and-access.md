...
| What does Wallet display? | `[SPECIFICATION]` Registered RP and service trade names; if intermediary, both RP and intermediary identities. It must not misleadingly show only the public body when the platform is a separate intermediary. |
